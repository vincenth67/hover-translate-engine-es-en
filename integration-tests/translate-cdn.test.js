/**
 * @fileoverview Single sentence translation test using CDN/online loading
 * 
 * This test demonstrates basic translation functionality using CDN model loading.
 * It shows performance metrics and memory usage for a single translation.
 * 
 * Test Structure:
 * ├── Single sentence translation with CDN
 * │   ├── Model loading from CDN
 * │   ├── Translation execution
 * │   └── Performance analysis
 */

import { loadEngine, translate, TranslationStatus } from '../src/engine.js';
...
async function runSingleSentenceTest() {
  console.log('🧪 Single Sentence Translation Test (CDN/ONLINE)');
  console.log('============================================================');
  console.log('🌐 MODE: Using CDN model loading (online)');
  console.log('📡 Model source: Hugging Face CDN (Xenova/opus-mt-es-en)');
  console.log('⚠️  Requires internet connectivity');
  console.log('');
  ...
  console.log('🔄 Step 1: Loading translation model (CDN/ONLINE)...');
